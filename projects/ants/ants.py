...
class Place(object):
    ...
    def add_insect(self, insect):
        ...
        if insect.is_ant:
            if self.ant is None:
                ...
                # BEGIN Problem 9
                if self.ant.container and self.ant.can_contain(insect): #insert an ant to a guard
                    self.ant.contain_ant(insect)
                elif not self.ant.container and insect.container and insect.can_contain(self.ant): #insert guard
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            # BEGIN Problem 13
            "*** YOUR CODE HERE ***"
            if isinstance(insect, QueenAnt) and insect.only:
                return
            # END Problem 13
...
class Bee(Insect):
    ...
    def blocked(self):
        ...
        # BEGIN Problem 7
        return self.place.ant is not None and self.place.ant.blocks_path        # END Problem 7
        #blocks_path is True for ant
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        count = 0
        while Place != hive:
            if bees and count >= self.min_range and count <= self.max_range:
...
class HungryAnt(Ant):
    ...
    implemented = True
    food_cost = 4
    armor = 1   # Change to True to view in the GUI
    # END Problem 6
    ...
    def eat_bee(self, bee):
        ...
        eatbee = random_or_none(bee)
        Insect.reduce_armor(eatbee, eatbee.armor)
...
# END Problem 13
    ...
    food_cost = 7
    count = 0
    only = False # Change to True to view in the GUI
    # END Problem 13
    ...
    def __init__(self):
        ...
        QueenAnt.count += 1
        if QueenAnt.count == 1:
            self.only = True #mark a only queen
        # END Problem 13
    ...
    def action(self, colony):
        ...
        if self.only:
            ...
            while place:
                if place.ant:
                    if place.ant.damage == type(place.ant).damage:
                        place.ant.damage = 2 * place.ant.damage
                    if place.ant.container and place.ant.ant:
                        if place.ant.ant.damage == type(place.ant.ant).damage:
